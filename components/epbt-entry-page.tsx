...
import { Activity, ArrowRight, ClipboardCheck, ClipboardList, Radio, ScrollText, ShieldAlert, Stethoscope } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="app-shell min-h-dvh bg-background/95 pb-28">
        <main className="space-y-5 px-4 pb-4 pt-3 md:px-6">
          <div>
            <h2 className="text-base font-semibold text-primary">Единые правила безопасности труда</h2>
